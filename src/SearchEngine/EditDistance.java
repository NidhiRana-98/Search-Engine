/**
 * EditDistance.java: Calculates the minimum cost required to change a word from one to another. Used to suggest correct words in the search Engine Application.
 */
